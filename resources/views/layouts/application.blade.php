              ...
              <ul class="nav navbar-nav">
                ...
                <li>
                  ...
                  <ul class="dropdown">
                    ...
                    <li>
                      <a class="active" href="add-resume">
                      Add Resume
                      </a>
                    </li>
                    <li>
                      <a href="manage-resumes">
                      Manage Resumes
                      </a>
                    </li>
                    <li>
          ...
          <ul class="wpb-mobile-menu">
            ...
            <li>
              ...
              <ul>
                ...
                <li><a class="active" href="add-resume">Add Resume</a></li>
            ...
            <li>
              ...
              <ul>
                <li><a href="post-job">Add Job</a></li>
