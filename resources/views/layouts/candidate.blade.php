          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">              
              ...
              <ul class="nav navbar-nav navbar-right float-right">
                <li class="right"><a href="Login"><i class="ti-lock"></i>  Logout</a></li>
              </ul>
            </div>
          </div>
          <!-- Mobile Menu Start -->
          <ul class="wpb-mobile-menu">
            ...
            <li>
              ...
              <ul>
                ...
                <li><a class="active" href="addResume">Add Resume</a></li>
                <li><a href="manage-resumes">Manage Resumes</a></li>
                <li><a href="jobAlerts">Job Alerts</a></li>
              </ul>
            </li>
            <li class="btn-m"><a href="my-account"><i class="ti-lock"></i>  Logout</a></li>          
          </ul>
          <!-- Mobile Menu End --> 
        </nav>
        ...
        <div class="row">         
          <div class="col-md-12">
            <div class="breadcrumb-wrapper">
              ...
              <ol class="breadcrumb">
                <li><a href="#"><i class="ti-home"></i> My Account</a></li>
