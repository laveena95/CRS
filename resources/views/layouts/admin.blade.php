...
<head>
  ...
  <title>CIS - Internships - @yield('title')</title>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <a href="index.html#">
                  <div class="task-info">
                    <div class="desc">AddCompanies</div>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="{{ asset('frontend/img/uLogo.jpg') }}" class="img-circle" width="80"></a></p>
