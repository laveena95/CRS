...
<h3><i class="fa fa-building"></i> <b>My Account</b> <i class="fa fa-angle-right"></i> <i class="fa fa-bell"></i> <b>@yield ('title')</b></h3>
    <!-- page start-->
    <div class="row mt">
                    ...
                    <div class="mail-option">
                        ...
                        <div class="btn-group hidden-phone">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider">Paul published</li>
                    ...
                    <div class="table-inbox-wrap ">
                        <table class="table table-inbox table-hover">
                            <tbody>
                                ...
                                <d class="view-message">Paul Publidhed in your wall</td>
                                <td class="view-message inbox-small-cells"><i class="fa fa-paperclip"></i></td>
