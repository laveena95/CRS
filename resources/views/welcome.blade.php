      ...
      <section id="intro" class="section-intro">
        <div class="logo-menu">
          <nav class="navbar navbar-default" role="navigation" data-spy="affix" data-offset-top="50">
            <div class="container">
              ...
              <ul class="nav navbar-nav navbar-right float-right">
                <li class="left"><a href="post-job.blade.php"><i class="ti-pencil-alt"></i> Post A Job</a></li>
                <li class="btn-m"><a href="login2"><i class="ti-lock"></i>  Log In</a></li> 
                <li class="btn-m"><a href="register2"><i class="ti-lock"></i>  Register</a></li> 
              </ul>
            </div>                           
          </div>
          <!-- Mobile Menu Start -->
          <ul class="wpb-mobile-menu">
            ...
            <li class="btn-m"><a href="post-job.blade.php"><i class="ti-pencil-alt"></i> Post A Job</a></li>
            <li class="btn-m"><a href="login2"><i class="ti-lock"></i>  Log In</a></li> 
            <li class="btn-m"><a href="register2"><i class="ti-lock"></i>  Register</a></li>          
          </ul>
          <!-- Mobile Menu End --> 
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="featured-item">
          <div class="featured-wrap">
            <div class="featured-inner">
              <figure class="item-thumb">
                <a class="hover-effect" href="job-page.blade.php">
                  <img src="{{ asset('frontend/img/features/img-1.jpg') }}" alt="">
                </a>
              </figure>
              <div class="item-body">
                <h3 class="job-title"><a href="job-page.blade.php">Graphic Designer</a></h3>
          ...
          <div class="item-foot">
            ...
            <div class="view-iocn">
              <a href="job-page.blade.php"><i class="ti-arrow-right"></i></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="featured-item">
          <div class="featured-wrap">
            <div class="featured-inner">
              <figure class="item-thumb">
                <a class="hover-effect" href="job-page.blade.php">
                  <img src="{{ asset('frontend/img/features/img-2.jpg') }}" alt="">
                </a>
              </figure>
              <div class="item-body">
                <h3 class="job-title"><a href="job-page.blade.php">Software Engineer</a></h3>
        ...
        <div class="featured-item">
          <div class="featured-wrap">
            <div class="featured-inner">
              <figure class="item-thumb">
                <a class="hover-effect" href="job-page.blade.php">
                  <img src="{{ asset('frontend/img/features/img-3.jpg') }}" alt="">
                </a>
              </figure>
              <div class="item-body">
                <h3 class="job-title"><a href="job-page.blade.php">Managing Director</a></h3>
