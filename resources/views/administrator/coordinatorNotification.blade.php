...
<section class="wrapper">
    <h3><i class="fa fa-user"></i> <b>Coordinator</b> <i class="fa fa-angle-right"></i> <i class="fa fa-bell"></i> <b>@yield('title')</b></h3>
    ...
    <div class="row mt">
        ...
        <form class="contact-form php-mail-form" role="form" action="contactform/contactform.php" method="POST">
            ...
            <i class="fa fa-user"></i><input type="name" name="name" class="form-control" id="contact-name" placeholder="Name of the Coordinator" data-rule="minlen:4" data-msg="Please enter at least 4 chars" >
