...
<section class="wrapper">
        <h3><i class="fa fa-home"></i> <b>Home</b> <i class="fa fa-angle-right"></i> <i class="fa fa-user"></i> <b>@yield('title')</b></h3>
        ...
        <div class="row mt">
            ...
            @endif
                ...
                <form class="form-horizontal style-form" method="POST" action="/coordinators"  autocomplete="off">
                {{csrf_field()}}
