...
@section('content')
  <section class="wrapper">
    <h3 style="margin-top:;"><i class="fa fa-users"></i> <b>Student Requests</b> <i class="fa fa-angle-right"></i> <i class="fa fa-exclamation-circle"><span class="badge bg-warning">{{ $pending->count() }}</span></i> @yield ('title')</h3>
          <div class="row mb">
                          ...
                          <tr class="gradeA">
                              ...
                              <td class="text-center">
                                @if($data->is_approved == 0)
                                    ...
                                    <form method="post" action="{{ action('ResumeController@approve',$data->id) }}" id="approval-form-{{ $data->id }}" style="display: none">
                                        @csrf
                                        @method('PUT')
                                    </form>
                                @endif
