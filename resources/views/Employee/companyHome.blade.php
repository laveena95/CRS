...
<section class="wrapper site-min-height">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-md-4 profile-text" style="margin-left:125px;">
                ...
                <h6>RECRUITER</h6>
                <p>Company name with location</p>
                <br>
            ...
            <div class="col-md-4 centered"style="margin-left:125px;">
                <div class="profile-pic">
                    <form  enctype="multipart/form-data" action="/companyAvatar" method="POST">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;border-color:white;" name="image" type="file">
                        <img src="uploads/Recruiter/Avatar/{{Auth::user()->image}}" class="img-circle" style="margin-top:-5px;">
                        </div>
